...
module.exports = function (restClient) {
    ...
    module.adyenPaymentStatus = function (orderId) {
        return restClient.post('/adyen/orders/payment-status', { orderId: orderId })
    }

    module.adyenPaymentDetails = function (details, orderId) {
        // const payload = JSON.stringify({ details: { redirectResult: paymentData }, orderId });
        const payload = JSON.stringify({ details, orderId });
        return restClient.post('/adyen/paymentDetails', { payload })
    }
