...
module.exports = function (restClient) {
    ...
    module.adyenPaymentMethods = function (customerToken, cartId, address) {
        if (customerToken && isNumeric(cartId)) {
            return restClient.post('/carts/mine/retrieve-adyen-payment-methods', { shippingAddress: address, cart_id: cartId })
        } else
        {
            return restClient.post('/guest-carts/' + cartId + '/retrieve-adyen-payment-methods', { shippingAddress: address })
        }
    }
