...
module.exports = function (restClient) {
    ...
    module.adyenPaymentMethods = function (customerToken, cartId, address) {
        if (customerToken && isNumeric(cartId)) {
            return restClient.post('/carts/mine/retrieve-adyen-payment-methods', { address: address }, customerToken)
        } else
        {
    ...
    module.adyenPaymentStatus = function (customerToken, orderId) {
        return restClient.post('/adyen/orders/payment-status', { orderId: orderId }, customerToken)
    }
