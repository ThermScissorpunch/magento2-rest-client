        ...
        return new Promise(function (resolve, reject) {
            request({
                ...
                headers: {
                    ...
                    ...customHeaders,
                    'CF-Access-Client-Id': options.cfAccessClientId ? options.cfAccessClientId : '',
                    'CF-Access-Client-Secret': options.cfAccessClientSecret ? options.cfAccessClientSecret : ''
                },
                json: true,
