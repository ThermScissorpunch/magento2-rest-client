...
module.exports.RestClient = function (options) {
    ...
    var userAgent = options.userAgent || 'magento2-rest-client';
        ...
        return new Promise(function (resolve, reject) {
            request({
                ...
                if (error) {
                    ...
                    if (request_data.body && request_data.body.password) {
                        request_data.body.password = 'XXXX';
                    }
                    logger.error(`API call failed to ${request_data.url}: ` + errorMessage + ' ' + JSON.stringify(request_data.body));
                    reject({
                        errorMessage,
...
//                resolve(bodyCamelized);
    ...
    instance.get = function (resourceUrl, request_token = '', customHeaders = {}) {
        var request_data = {
    ...
    instance.put = function (resourceUrl, data, request_token = '', customHeaders = {}) {
        var request_data = {
            url: createUrl(resourceUrl),
            method: 'PUT',
            body: data
    ...
    instance.delete = function (resourceUrl, request_token = '', customHeaders = {}) {
        var request_data = {
            url: createUrl(resourceUrl),
            method: 'DELETE'
        };
